...
const Home = () => {
  ...
  const flowNavigateHandler = (idFlow) => {
  ...
  return (
    <Wrapper>
      ...
      <Wrapper.CardContainer>
        <Card
          onClick={() => flowNavigateHandler(1)}
          title={'Flow № 1'}
          img={flow1}
        />
        <Card
          onClick={() => flowNavigateHandler(2)}
          title={'FLow № 2'}
          img={flow2}
        />
      </Wrapper.CardContainer>
      <Wrapper.CardContainer>
        <Card
          onClick={() => flowNavigateHandler(3)}
          title={'Flow № 3'}
          img={flow3}
        />
        <Card
          onClick={() => flowNavigateHandler(4)}
          title={'Flow № 4'}
          img={flow4}
        />
      </Wrapper.CardContainer>
